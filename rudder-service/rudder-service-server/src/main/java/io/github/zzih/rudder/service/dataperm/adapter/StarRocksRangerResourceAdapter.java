...
/**
 * STARROCKS plugin adapter,对应 StarRocks Ranger servicedef({@code name = "starrocks"})。
 * StarRocks 3.x 内置 catalog 概念(internal + external),hierarchy 四层。
 */
@Component
public class StarRocksRangerResourceAdapter extends AbstractRangerResourceAdapter {

    public StarRocksRangerResourceAdapter(GlobalCacheService cache,
