...
@Service
public class VersionConfigService extends AbstractConfigService<VersionStore> {

    private final VersionPluginManager pluginManager;

    public VersionConfigService(GlobalCacheService cache, SpiConfigDao spiConfigDao,
                                VersionPluginManager pluginManager) {
        super(cache, GlobalCacheKey.VERSION, ConfigErrorCode.VERSION_NOT_CONFIGURED, spiConfigDao, SpiType.VERSION);
    ...
    @Override
    protected VersionStore buildInstance(String provider, String providerParamsJson) {
