...
/**
 * HADOOP_SQL plugin adapter,对应 Hive Ranger servicedef({@code name = "hive"})。
 * Hive / Spark Thrift Server / Impala 共用此 plugin,policy 都写到同一份 hive service。
 */
@Component
public class HadoopSqlRangerAdapter extends AbstractRangerResourceAdapter {

    public HadoopSqlRangerAdapter(GlobalCacheService cache,
