...
@Component
class WorkflowPublishStageFlow extends AbstractPublishStageFlow {

    WorkflowPublishStageFlow(ProjectDao projectDao) {
        super(projectDao);
    }

    @Override
    public String resourceType() {
        return ApprovalResourceType.WORKFLOW_PUBLISH;
    }
}
