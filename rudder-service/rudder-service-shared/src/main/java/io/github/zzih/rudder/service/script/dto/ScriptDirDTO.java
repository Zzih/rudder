...
public class ScriptDirDTO {
    ...
    @JsonPropertyDescription("Directory name (must be unique among siblings)")
    private String name;

    @JsonPropertyDescription("Display order among siblings (smaller = earlier)")
