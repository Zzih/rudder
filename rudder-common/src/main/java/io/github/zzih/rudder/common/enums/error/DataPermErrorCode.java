...
public enum DataPermErrorCode implements ErrorCode {
    ...
    ACCESS_GROUP_NOT_FOUND(9330, "err.DataPermErrorCode.ACCESS_GROUP_NOT_FOUND"),
    ACCESS_GROUP_NAME_DUPLICATE(9331, "err.DataPermErrorCode.ACCESS_GROUP_NAME_DUPLICATE"),
    ACCESS_GROUP_IN_USE(9332, "err.DataPermErrorCode.ACCESS_GROUP_IN_USE"),
    ACCESS_GROUP_SCOPE_MISMATCH(9333, "err.DataPermErrorCode.ACCESS_GROUP_SCOPE_MISMATCH"),
    ACCESS_GROUP_REQUIRED(9334, "err.DataPermErrorCode.ACCESS_GROUP_REQUIRED"),
