...
public enum WorkspaceErrorCode implements ErrorCode {
    ...
    AUTH_SOURCE_CONFIG_INVALID(1085, "err.WorkspaceErrorCode.AUTH_SOURCE_CONFIG_INVALID"),
    ...
    REQUIRES_WORKSPACE_OWNER(1113, "err.WorkspaceErrorCode.REQUIRES_WORKSPACE_OWNER"),
    REQUIRES_DEVELOPER(1114, "err.WorkspaceErrorCode.REQUIRES_DEVELOPER"),
    INSUFFICIENT_PRIVILEGES(1115, "err.WorkspaceErrorCode.INSUFFICIENT_PRIVILEGES"),
