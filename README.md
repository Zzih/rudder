...
每个 provider 都自带:
- 中英双语 Markdown 接入指南(`spi-guide/<type>-<provider>.{zh,en}.md`)— 装在 jar 里随 provider 走
...
| Execution (rudder-execution) | `RUDDER_EXECUTION_HTTP_PORT` (5681) | `RUDDER_EXECUTION_RPC_PORT` (5691) | 同上 |
