...
public class SparkJarTaskChannel implements TaskChannel {

    @Override
    public AbstractTask createTask(TaskExecutionContext ctx) {
        SparkJarTaskParams params = JsonUtils.fromJson(ctx.getParamsJson(), SparkJarTaskParams.class);
        return new SparkJarTask(ctx, params);
    }

    @Override
    public AbstractTaskParams parseParams(String paramsJson) {
        return JsonUtils.fromJson(paramsJson, SparkJarTaskParams.class);
    }
}
