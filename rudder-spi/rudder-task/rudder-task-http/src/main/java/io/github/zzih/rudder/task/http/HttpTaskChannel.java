...
public class HttpTaskChannel implements TaskChannel {
    ...
    public AbstractTask createTask(TaskExecutionContext ctx) {
        HttpTaskParams params = JsonUtils.fromJson(ctx.getParamsJson(), HttpTaskParams.class);
        return new HttpTask(ctx, params);
    }

    @Override
    public AbstractTaskParams parseParams(String paramsJson) {
        return JsonUtils.fromJson(paramsJson, HttpTaskParams.class);
    }
}
