...
public class FlinkJarTaskChannel implements TaskChannel {

    @Override
    public AbstractTask createTask(TaskExecutionContext ctx) {
        FlinkJarTaskParams params = JsonUtils.fromJson(ctx.getParamsJson(), FlinkJarTaskParams.class);
        return new FlinkJarTask(ctx, params);
    }

    @Override
    public AbstractTaskParams parseParams(String paramsJson) {
        return JsonUtils.fromJson(paramsJson, FlinkJarTaskParams.class);
    }
}
