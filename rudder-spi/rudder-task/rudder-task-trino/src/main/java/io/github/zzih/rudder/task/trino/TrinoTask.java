...
package io.github.zzih.rudder.task.trino;
...
public class TrinoTask extends AbstractJdbcSqlTask {

    public TrinoTask(TaskExecutionContext ctx, SqlTaskParams params) {
        super(ctx, params);
    }
