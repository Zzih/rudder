...
package io.github.zzih.rudder.task.clickhouse;
...
public class ClickhouseTask extends AbstractJdbcSqlTask {

    public ClickhouseTask(TaskExecutionContext ctx, SqlTaskParams params) {
        super(ctx, params);
    }
