...
package io.github.zzih.rudder.task.doris;
...
public class DorisTaskChannelFactory implements TaskChannelFactory {

    @Override
    public TaskType getTaskType() {
        return TaskType.DORIS_SQL;
    }

    @Override
    public TaskChannel create() {
        return new DorisTaskChannel();
    }
}
