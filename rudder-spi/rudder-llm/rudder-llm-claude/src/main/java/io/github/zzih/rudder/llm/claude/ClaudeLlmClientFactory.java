...
public class ClaudeLlmClientFactory implements LlmClientFactory<ClaudeProperties> {
    ...
    @Override
    public Class<ClaudeProperties> propertiesClass() {
        return ClaudeProperties.class;
    }
    ...
    @Override
    public LlmClient create(ProviderContext ctx, ClaudeProperties props) {
