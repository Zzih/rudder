...
@Mapper
public interface DataPermBundleMapper extends BaseMapper<DataPermBundle> {

    DataPermBundle queryOneByName(@Param("name") String name);

    com.baomidou.mybatisplus.core.metadata.IPage<DataPermBundle> queryPage(
