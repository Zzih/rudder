...
@Mapper
public interface DataPermRoleMapper extends BaseMapper<DataPermRole> {

    DataPermRole queryOneByName(@Param("name") String name);

    com.baomidou.mybatisplus.core.metadata.IPage<DataPermRole> queryPage(
