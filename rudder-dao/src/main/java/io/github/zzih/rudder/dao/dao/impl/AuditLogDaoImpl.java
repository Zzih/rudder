...
public class AuditLogDaoImpl implements AuditLogDao {
    ...
    @Override
    public IPage<AuditLog> selectPage(String module, String action, String username,
                                      String startTime, String endTime,
                                      int pageNum, int pageSize) {
        return auditLogMapper.queryPage(new Page<>(pageNum, pageSize),
                module, action, username, startTime, endTime);
    }
}
