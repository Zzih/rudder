...
public interface AiToolConfigMapper extends BaseMapper<AiToolConfig> {
    ...
    AiToolConfig selectByToolName(@Param("toolName") String toolName);

    List<AiToolConfig> selectAllOrdered();

    IPage<AiToolConfig> selectPageOrdered(IPage<AiToolConfig> page);
}
