 ...
 *
 * <p>RBAC 语义:仅引用 role_id,实际权限项内容现场 JOIN
 * {@link DataPermRolePermission} 当前态(自动跟随包变化)。
 *
 * <p>生命周期:
 * <ul>
 ...
 */
@Data
@TableName("t_r_data_perm_user_role_grant")
public class DataPermUserRoleGrant implements Serializable {
