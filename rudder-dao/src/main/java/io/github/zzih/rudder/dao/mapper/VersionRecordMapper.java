...
public interface VersionRecordMapper extends BaseMapper<VersionRecord> {
    ...
    List<VersionRecord> queryByResourceOrderByVersionNoDesc(@Param("resourceType") ResourceType resourceType,
                                                            @Param("resourceCode") Long resourceCode);

    IPage<VersionRecord> queryPageByResource(IPage<VersionRecord> page,
                                             @Param("resourceType") ResourceType resourceType,
                                             @Param("resourceCode") Long resourceCode);

    VersionRecord queryLatestByResource(@Param("resourceType") ResourceType resourceType,
                                        @Param("resourceCode") Long resourceCode);
}
